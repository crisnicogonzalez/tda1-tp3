def select(ships, damage_table, board):
    ...
    for ship in ships:
        damage_from_ship = damage_table.get_damage_from_pos(ship.get_pos_x(), ship.get_pos_y())
    ...
    board.attack_to_position(lower_life_ship.get_pos_x(), lower_life_ship.get_pos_y())
