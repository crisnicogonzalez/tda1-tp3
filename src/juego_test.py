...
class JuegoTest (unittest.TestCase):
    ...
    def test_insertar_barco_dentro_del_tablero_cuadrado_queda_bien_posicionado(self):
        ...
        self.assertEqual(titanic.get_pos_x(), 0, "Posicion X no es 0")
        self.assertEqual(titanic.get_pos_y(), 0, "Posicion Y no es 0")
    ...
    def test_insertar_barco_dentro_del_borde_del_tablero_rectangular_queda_bien_posicionado(self):
        ...
        self.assertEqual(titanic.get_pos_x(), 9, "Posicion X no es 9")
        self.assertEqual(titanic.get_pos_y(), 2, "Posicion Y no es 2")
        ...
        self.assertEqual(titanic.get_pos_x(), 5, "Posicion X no es 5")
        self.assertEqual(titanic.get_pos_y(), 19, "Posicion Y no es 19")
    ...
    def test_insertar_barco_fuera_del_tablero_falla_y_no_modifica_el_barco(self):
        ...
        self.assertEqual(titanic.get_pos_x(), None, "Posicion X no es nula")
        self.assertEqual(titanic.get_pos_y(), None, "Posicion Y no es nula")
    ...
    def test_crear_juego_ubica_los_barcos_en_el_tablero(self):
        ...
        self.assertNotEqual(titanic.get_pos_x(), None, "Posicion X no fue seteada")
        self.assertNotEqual(titanic.get_pos_y(), None, "Posicion Y no fue seteada")
        self.assertEqual(oceano.get_item_from_position(titanic.get_pos_x(), titanic.get_pos_y()), titanic, "El barco no se ubico en el tablero")
        self.assertNotEqual(santamaria.get_pos_x(), None, "Posicion X no fue seteada")
        self.assertNotEqual(santamaria.get_pos_y(), None, "Posicion Y no fue seteada")
        self.assertEqual(oceano.get_item_from_position(santamaria.get_pos_x(), santamaria.get_pos_y()), santamaria, "El barco no se ubico en el tablero")
    ...
    def test_crear_juego_poner_barco_y_hacerlo_avanzar_actualiza_la_posicion_del_barco_y_tablero(self):
        ...
        xInicial = titanic.get_pos_x()
        yInicial = titanic.get_pos_y()
        titanic.advance_to_new_position()
        self.assertEqual(titanic.get_pos_x(), xInicial + 1, "La posicion del barco en x no se modifico")
        self.assertEqual(titanic.get_pos_y(), yInicial, "La posicion del barco en y se modifico")
    ...
    def test_barco_avanza_hasta_el_final_y_da_la_vuelta(self):
        ...
        self.assertEqual(oceano.get_item_from_position(xInicial + 1, yInicial), titanic, "El barco no avanzo en el tablero")
        titanic.advance_to_new_position()
        self.assertEqual(titanic.get_pos_x(), xInicial + 2, "La posicion del barco en x no se modifico")
        self.assertEqual(oceano.get_item_from_position(xInicial + 2, yInicial), titanic, "El barco no avanzo en el tablero")
        titanic.advance_to_new_position()
        self.assertEqual(titanic.get_pos_x(), xInicial, "El barco no dio la vuelta")
        self.assertEqual(titanic.get_pos_y(), yInicial, "La posicion del barco en y se modifico")
